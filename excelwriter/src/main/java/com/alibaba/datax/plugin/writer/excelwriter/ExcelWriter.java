        ...
        private void validateParameter() {
            this.writerSliceConfig
                    .getNecessaryValue(
                            ...
                            ExcelWriterErrorCode.REQUIRED_VALUE);
            ...
            try {
                ...
                if (!dir.exists()) {
                    ...
                    if (!createdOk) {
                        throw DataXException
                                .asDataXException(
                                        ExcelWriterErrorCode.CONFIG_INVALID_EXCEPTION,
                ...
                throw DataXException.asDataXException(
                        ExcelWriterErrorCode.SECURITY_NOT_ENOUGH,
    ...
    public static class Task extends Writer.Task {
        ...
        public void startWrite(RecordReceiver lineReceiver) {
            ...
            try {
                ...
                throw DataXException.asDataXException(
                        ExcelWriterErrorCode.Write_FILE_IO_ERROR,
